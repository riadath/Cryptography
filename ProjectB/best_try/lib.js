...
async function computeDH(myPrivateKey, theirPublicKey) {
  // Ensure the derived key is of type 'AES-GCM'
  
  return await crypto.subtle.deriveKey(
    { name: 'ECDH', public: theirPublicKey },
    myPrivateKey,
    { name: 'AES-GCM', length: 256 },  // Set the correct algorithm for AES-GCM
    true,  // whether the key is extractable, set to true for debugging, false for production
    ['encrypt', 'decrypt']  // Specify key usages
  );
}
